        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <FooterSection title={t('footer.quickLinks')}>
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/about" className="text-gray-400 hover:text-waladom-green">
                  {t('nav.about')}
                </Link>
              </li>
              <li>
                <Link to="/events" className="text-gray-400 hover:text-waladom-green">
                  {t('nav.events')}
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-400 hover:text-waladom-green">
                  {t('nav.contact')}
                </Link>
              </li>
            </ul>
