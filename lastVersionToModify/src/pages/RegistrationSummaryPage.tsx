  ...
  const sections = [
    {
      ...
      fields: [
        { label: t('registration.firstName'), value: trimValue(formData.firstName) },
        { label: t('registration.lastName'), value: trimValue(formData.lastName) },
        { label: t('registration.sex'), value: trimValue(formData.sex) },
        { label: t('registration.maritalStatus'), value: trimValue(formData.maritalStatus) },
        { label: t('registration.numberOfKids'), value: formData.numberOfKids.toString() }
      ]
    },
    {
    ...
    },
    {
      ...
      fields: [
        { label: t('registration.birthDate'), value: trimValue(formData.birthDate) },
        { label: t('registration.birthCountry'), value: trimValue(formData.birthCountry) },
        { label: t('registration.birthCity'), value: trimValue(formData.birthCity) },
        { label: t('registration.birthVillage'), value: trimValue(formData.birthVillage) }
      ]
    },
    {
      title: t('registration.currentLocation'),
      fields: [
        { label: t('registration.currentCountry'), value: trimValue(formData.currentCountry) },
        { label: t('registration.currentCity'), value: trimValue(formData.currentCity) },
        { label: t('registration.currentVillage'), value: trimValue(formData.currentVillage) }
      ]
    },
    {
      title: t('registration.additionalInfo'),
      fields: [
        { label: t('registration.occupation'), value: trimValue(formData.occupation) },
        ...
        { label: t('registration.invitationCode'), value: trimValue(formData.invitedBy) },
        { label: t('registration.comments'), value: trimValue(formData.comments) }
      ]
    },
    {
      title: t('registration.motherInfo'),
      fields: [
        { label: t('registration.mothersFirstName'), value: trimValue(formData.mothersFirstName) },
        { label: t('registration.mothersLastName'), value: trimValue(formData.mothersLastName) }
      ]
    }
  ];
